...
public class KinectV1 extends DPat {

    public static final boolean USE_V2 = false;
    ...
    private org.openkinect.processing.Kinect kinect;
    private Kinect2 kinect2;

    public KinectV1(LX lx) {
        super(lx);
        ...
        if (USE_V2) {
            ...
            kinect = new org.openkinect.processing.Kinect(SLStudio.applet);
            kinect.initVideo();
            kinect.initDepth();
            kinect.initVideo();
            //kinect.enableIR(ir);
    ...
    public int CalcPoint(PVector p) {
        ...
        int index = xKinect + yKinect * (USE_V2 ? kinect2.depthWidth : depthWidth);
