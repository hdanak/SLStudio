...
public class ChurchShow implements Show, HasWorkspace {
    public static final String SHOW_NAME = "church";
    public static final String LOG_TAG = "[ChurchShow] ";
    ...
    public ChurchModel buildModel() {
        ...
        return new ChurchModel("church", crossStrips, haloStrips, flowerStrips, aisleStrips, stringStrips);
    }

    public static class ChurchModel extends StripsModel {
        public final List<Strip> crossStrips, haloStrips, flowerStrips, aisleStrips, stringStrips;

        public ChurchModel(String name, List<Strip> crossStrips,
